...
class TermsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create term" do
    assert_difference('Term.count') do
      post terms_url, params: { term: { description: @term.description, name: @term.name, weight: @term.weight } }
    end
  ...
  test "should update term" do
    patch term_url(@term), params: { term: { description: @term.description, name: @term.name, weight: @term.weight } }
